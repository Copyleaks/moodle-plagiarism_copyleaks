...
function xmldb_plagiarism_copyleaks_upgrade($oldversion) {
    ...
    if ($oldversion < 2023042406) {
        ...
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));
        $table->add_key('cmid_fk', XMLDB_KEY_FOREIGN, array('cmid'), 'course_modules', array('id'));
        ...
        $table->add_key('ci_user_id_fk', XMLDB_KEY_FOREIGN, array('ci_user_id'), 'plagiarism_copyleaks_users', array('userid'));
