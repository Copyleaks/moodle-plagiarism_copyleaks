...
$string['clundermaintain'] = 'Copyleaks server is under maintenance';
...
$string['cldisablesettingstooltip'] = "Please wait until Copyleaks will establish a new course module";
