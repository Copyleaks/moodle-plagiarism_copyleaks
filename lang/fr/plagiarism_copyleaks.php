...
$string['cldefaultrepositoriespagetitle'] = 'Paramètres de référentiels par défaut de Copyleaks';
...
$string['clshowstudentresultsinfo'] = "Afficher les informations sur les étudiants dans les résultats";
$string['clshowstudentresultsinfo_help'] = "Les instructeurs pourront voir plus de détails sur les étudiants dans la carte de résultats";
...
$string['clsettingspagetitle'] = 'Copyleaks Paramètres';
$string['clsettingspagetitle'] = 'Rapport sur les fuites de copie';
...
$string['clscaninternet'] = 'Numériser Internet';
